...
export class GameInfoComponent implements OnInit, OnChanges {
  cardAction = [
    ...
    },
    {
      title: 'Thumbmaster',
      description:
        'When you put your thumb on the table, everyone must follow. The last person to put their thumb down, drinks.',
    },
    { title: 'Men', description: 'All men drink.' },
    {
      title: 'Quizmaster',
      description:
        'You become the question master, and if anybody answers a question asked by you (the player who drew the card), they have to drink.',
    },
    {
